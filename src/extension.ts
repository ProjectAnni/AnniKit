...
export function activate(context: vscode.ExtensionContext) {
  ...
  if (rootPath) {
    ...
    context.subscriptions.push(...WorkspaceProvider.register(rootPath), vscode.workspace.registerTextDocumentContentProvider("anni", new AnniRepoContentProvider(rootPath)),);
